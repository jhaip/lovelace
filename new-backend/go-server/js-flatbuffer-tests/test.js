...
let sss = `{"source":"1200","subscriptionId":"2535b96f-f262-42db-ba7b-279ef65a617b","results":[{"y":1210,"x":1200,"time2":1569031507050,"time1":1569031507012}]}`
...
let bbb = new Uint8Array([16, 0, 0, 0, 0, 0, 10, 0, 16, 0, 12, 0, 8, 0, 4, 0, 10, 0, 0, 0, 68, 0, 0, 0, 8, 0, 0, 0, 48, 0, 0, 0, 36, 0, 0, 0, 50, 53, 51, 53, 98, 57, 54, 102, 45, 102, 50, 54, 50, 45, 52, 50, 100, 98, 45, 98, 97, 55, 98, 45, 50, 55, 57, 101, 102, 54, 53, 97, 54, 49, 55, 98, 0, 0, 0, 0, 4, 0, 0, 0, 49, 50, 48, 48, 0, 0, 0, 0, 1, 0, 0, 0, 12, 0, 0, 0, 0, 0, 6, 0, 8, 0, 4, 0, 6, 0, 0, 0, 4, 0, 0, 0, 4, 0, 0, 0, 16, 0, 0, 0, 44, 0, 0, 0, 72, 0, 0, 0, 124, 0, 0, 0, 146, 255, 255, 255, 12, 0, 0, 0, 0, 0, 0, 2, 12, 0, 0, 0, 4, 0, 0, 0, 49, 50, 49, 48, 1, 0, 0, 0, 121, 0, 0, 0, 178, 255, 255, 255, 12, 0, 0, 0, 0, 0, 0, 2, 12, 0, 0, 0, 4, 0, 0, 0, 49, 50, 48, 48, 1, 0, 0, 0, 120, 0, 0, 0, 210, 255, 255, 255, 12, 0, 0, 0, 0, 0, 0, 2, 24, 0, 0, 0, 13, 0, 0, 0, 49, 53, 54, 57, 48, 51, 49, 53, 48, 55, 48, 53, 48, 0, 0, 0, 5, 0, 0, 0, 116, 105, 109, 101, 50, 0, 10, 0, 16, 0, 12, 0, 11, 0, 4, 0, 10, 0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 2, 24, 0, 0, 0, 13, 0, 0, 0, 49, 53, 54, 57, 48, 51, 49, 53, 48, 55, 48, 49, 50, 0, 0, 0, 5, 0, 0, 0, 116, 105, 109, 101, 49, 0, 0, 0])

var t02 = performance.now();

for (let i = 0; i < 100; i += 1) {
    deserializeRoomResponseMessage(bbb)
}

var t12 = performance.now();
console.log("Call to doSomething took " + (t12 - t02) + " milliseconds.");