...
def init(root_filename, skipListening=False):
    ...
    # client.send_multipart(".....PING{}{}".format(
    #     MY_ID_STR, init_ping_id), zmq.NOBLOCK)
    client.send_multipart([".....PING{}{}".format(MY_ID_STR, init_ping_id).encode()])
    # print("send ping {}".format(MY_ID_STR))
    listen()
    ...
    # while True:
    #     raw_msg = client.recv_multipart()
    #     print("recv {}".format(raw_msg))
    #     msg = raw_msg[0].decode()
    #     id = msg[source_len:(source_len + SUBSCRIPTION_ID_LEN)]
    #     val = msg[(source_len + SUBSCRIPTION_ID_LEN +
    #                 server_send_time_len):]
    #     if id == init_ping_id:
    #         server_listening = True
    #         print("server is listening {}".format(MY_ID_STR))
    #         break
    #     else:
    #         print("recv'd not PING message, looping again")
